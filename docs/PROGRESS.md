...
| ??/??/?????? | ?????/????/??/???? |
| ?????/???? Punch ??/????? | |
| ???????Euclid????? | --school ????1????+?????summon VICTORY ?? |

### ????????24 ??3 ????????
- summon/defense/wind 100%?**0%**????????? wave3 Boss ?????????**????**
- water 0%?50%?????ice 33%?50%????
- ???????????teleport 0 ???????

### ?????????
1. **??????**?Linnaeus ?????spells.json teleport/counterspell ? disabled:true + game_state ??????_active_cores ?? _active_shells?
2. **????????**?Linnaeus ???????????? scale bug???????? 20x30 ??? 94% + ??? 1.15 ?????work/scale_check/ ?????
3. teleport ????????? or ???
4. git ????????Euclid ?????? + ?????
5. ? 3 ?????????????????

### ?????
- ?????????? taskkill ???A ???? 0%?????????? CSV?--csv ?????
- ??/??????????????????????
- ????????????
...
| ?? | ?? |
|---|---|
| 18 ??? P0??????????????????(PC1.5/??1.1)???(?8????+????)??????????Boss????????(??3?)?????? | ? |
| 18 ??? P1?????(4????)?Boss????(CD/????)?????(HP??6???????+???????) | ? |
| ????? 9 ????fx_manager??/Boss?????/??????/???????/?????/??????????? | ? |
| DPS ????GameState 5s?????? + HUD ?? + ??????? | ? |
| ??? P0+P1??? velocity ?????? fx_hit_slow ??? | ? |
| ?????Popper ?? 15 ?????? + ????? | ? |
| ???????????4???????? 80/140/240? | ? |
| ???????wand_expander ??+1?? | ? |
| ????1-2?????(HP80/??200/??DPS20)?????? | ? |
| ????5?????/??????????????1???? | ? |
| ???????holy/curse/melee/ice ???????? _take_raw? | ? |
| ???????level._spawn_boss ? _boss_spawned? | ? |
| ???? VICTORY?442s/2622?/hp355? + SMOKE OK + BOSS SKILLS OK | ? |
...
3. ???? 6????????????????????
4. ???? 7???????/???????? ? ?? ? ?? ? ??????
5. git commit + ?? v46??? main_menu ???
6. ? 5 ??????

### ???????
- enemy_hit ??????? take_damage??????????????????? _take_raw
- level.init_level ? add_child ???? get_tree() ? null??? call_deferred
- ???? _spawn_boss ??? _boss_spawned
- autoplay ??????? GB ????????
